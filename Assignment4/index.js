...
app.get('/articles', (req, res) => {
    contentService.getArticlesWithCategoryNames().then(articles => {
...
app.get('/article/:id', (req, res) => {
    contentService.getArticleById(req.params.id).then(article => {
...
contentService.initialize().then(() => {
    ...
    app.get('/api/published-articles', (req, res) => {
